...
from user.attachinfo.constant import MAX_SCHOOL_LENGTH, MAX_COMPANY_LENGTH, MAX_LOCATION_LENGTH, MAX_ABOUT_LENGTH, \
    DEFAULT_ABOUT, MAX_GRAVATAR_LENGTH, MAX_USERNAME_LENGTH
...
class AttachInfo(models.Model):
    ...
    codeforces = models.CharField(max_length=MAX_USERNAME_LENGTH, blank=True, default='errorerror')
    atcoder = models.CharField(max_length=MAX_USERNAME_LENGTH, blank=True)
