...
class _Permission(Enum):
    ...
    SUBMISSION_VIEW_ALL = _permission_meta(
        ...
        model='submission',
        codename='view_all')
    DISCUSSION_VIEW_ALL = _permission_meta(
        app_label='discussion',
        model='discussion',
        codename='view_all')
    DISCUSSION_CHANGE_VISIBILITY = _permission_meta(
        app_label='discussion',
        model='discussion',
        codename='change_visibility')
    ...
    def set_permission(self, user):
        content_type = ContentType.objects.get(
            app_label=self.value.app_label, model=self.value.model)
        user.user_permissions.add(Permission.objects.get(
            content_type=content_type, codename=self.value.codename))
...
class Group(Enum):
    ...
    NORMAL_ADMIN = _group_meta(
        ...
        permission=(_Permission.CONTEST_HIDE_SUBMISSION, _Permission.CONTEST_VIEW_ALL, _Permission.PROBLEM_ADD_PPROBLEM,
                    _Permission.PROBLEM_CHANGE_PROBLEM, _Permission.PROBLEM_DOWNLOAD_DATA, _Permission.PROBLEM_VIEW_ALL, _Permission.SUBMISSION_VIEW_ALL,
                    _Permission.DISCUSSION_VIEW_ALL, _Permission.DISCUSSION_CHANGE_VISIBILITY)
    )
    ...
    SUPER_ADMIN = _group_meta(
        ...
        permission=NORMAL_ADMIN.permission + (_Permission.CONTEST_ADD_CONTEST, _Permission.CONTEST_CHANGE_CONTEST,
                                              _Permission.USER_SET_NORMAL_USER, _Permission.USER_SET_NORMAL_ADMIN)
    )
