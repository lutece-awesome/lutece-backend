...
def get_judge_result_color(result):
    return Judge_result.get_judge_result(result).value.color


def get_judge_result_icon(result):
    return Judge_result.get_judge_result(result).value.icon


def check_judge_result_in_listshow_field(result):
    return Judge_result.get_judge_result(result) in Query_field.listshow_field.value


def is_compile_error(result):
    return Judge_result.get_judge_result(result) is Judge_result.CE
