...
from .views import get_contest_list, create_contest, edit_contest, update_contest, overview_contest, \
    get_contest_problem, get_problem_list, get_contest_submission, get_contest_detail, get_contest_rank
...
urlpatterns = [
    ...
    path('<int:pk>/overview', overview_contest, name='contest-overview'),
    ...
    path('<int:pk>/detail', get_contest_detail, name='contest-detail'),
